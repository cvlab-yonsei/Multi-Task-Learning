...
## AMTL
_parser.add_argument('--potentials_nyusp', type=str, default='[[0.6473], [4.0947], [0.2173]]', help=' ')
# _parser.add_argument('--potentials_officehome', type=str, default='[[0.7018], [0.7900], [0.8985], [0.8152]]', help=' ') 
# _parser.add_argument('--potentials_qm9', type=str, default=, help=' ')
# _parser.add_argument('--potentials_xtreme', type=str, default=, help=' ')
_parser.add_argument('--focusing_factor', type=float, default=2.0, help='focusing_factor for AMTL')
...
def prepare_args(params):
    ...
    if params.weighting in ['EW', 'Arithmetic','UW', 'GradNorm', 'GLS', 'RLW', 'MGDA', 'IMTL', 'IMTL_L', 'IMTL_G',
                            'LSBwD', 'LSBwoD',
