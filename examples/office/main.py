...
def main(params):
    ...
    train_dataloaders = {task: data_loader[task]['train'] for task in task_name} # {'Art':  {}}
    # data_loader['Art'] = {'train': DataLoader, 'val':DataLoader, 'test':DataLoader}
    # train_dataloaders = {'Art':DataLoader, ...}
